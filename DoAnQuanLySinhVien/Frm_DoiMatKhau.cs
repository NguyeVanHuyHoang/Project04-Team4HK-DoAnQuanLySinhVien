    ...
    public partial class Frm_DoiMatKhau : Form
    {
        ...
        private void btn_DongY_Click(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(txt_MK1.Text))
            {
                ...
                {
                    MessageBox.Show("Vui lòng xác nhận mật khẩu ", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void txt_HienThiTK_TextChanged(object sender, EventArgs e)
        {
