...
namespace DoAnQuanLySinhVien
{
    public class Cls_Main
    {
        ...
        public static string pathfileLopHoc = string.Format(@"{0}\list_QLLH.ini", Application.StartupPath);
        public static string pathfileSV = string.Format(@"{0}\list_QLSV.ini", Application.StartupPath);
        public static string pathfileSVExcel = Application.StartupPath + @"\SVXuatExcel.ini";
        public static string pathXuatFileExcelSV = Application.StartupPath + @"\SVXuatExcel.xls";
