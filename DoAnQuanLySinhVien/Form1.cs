...
namespace DoAnQuanLySinhVien
{
    public partial class Form1 : Form
    {
        ...
        {
            this.trangThaiMoTa = true;
            this.tieuDeTab = "Phân lớp, chuyển lớp";

            if (!CheckOpenTabs(tieuDeTab))
            {
                TabItem t = tc_Main.CreateTab(tieuDeTab);
                t.Name = "Frm_PhanLopChuyenLop";
                Frm_PhanLopChuyenLop frm = new Frm_PhanLopChuyenLop()
                {
                    DongTab = new Frm_PhanLopChuyenLop._deDongTab(DongTab),
                    frm = this,
                    TopLevel = false,
                    Dock = DockStyle.Fill
